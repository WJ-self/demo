...
# python inference.py --checkpoint_path pretrained/demo_best_231214.pth --device 0 --h5_file_path /root/autodl-tmp/data_eventcnn/ECD_H5/val/shapes_6dof.h5 --output_folder 